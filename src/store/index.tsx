...
interface initialState{login?:{userName:string,passWord:string,showRegister:boolean,registerName:string,registerPassword:string,registerPassword1:string}}
